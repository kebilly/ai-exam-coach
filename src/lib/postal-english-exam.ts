...
const operationTranslation = [
  text("Translation", "translation_zh_en", "Translate into English:\n臺灣舉重選手郭婞淳在國際賽事中贏得女子五十八公斤級金牌，並打破大會紀錄。她告訴媒體，當她看到觀眾席上熟悉的面孔大聲為她加油時，感到格外振奮，也因此鼓起勇氣舉起一百四十二公斤，與支持她的人共享榮耀。", "Taiwanese weightlifter Kuo Hsing-chun won the gold medal in the women's 58-kilogram category at an international competition and broke the event record. She told the media that seeing familiar faces in the audience cheering loudly for her made her especially excited and gave her the courage to lift 142 kilograms and share the glory with those who supported her.", "重點：weightlifter、58-kilogram category、broke the record、familiar faces、cheering loudly、gave her the courage、share the glory。", 5),
  text("Translation", "translation_zh_en", "Translate into English:\n為了提升服務品質，中華郵政要求各分局在月底前完成新作業流程的教育訓練。主管表示，員工不僅要熟悉規定本身，也要理解制度背後的目的，才能在面對民眾疑問時提供清楚且一致的說明。", "To improve service quality, Chunghwa Post required all branches to complete training on the new operating procedures before the end of the month. The supervisor said that employees should be familiar not only with the rules themselves but also with the purpose behind the system, so that they can provide clear and consistent explanations when answering public inquiries.", "重點：improve service quality、complete training、operating procedures、not only...but also、purpose behind the system、clear and consistent explanations。", 5),
  text("Translation", "translation_zh_en", "Translate into English:\n近年來，越來越多民眾使用線上服務查詢郵件狀態或辦理申請。然而，對於涉及個人資料或金融交易的業務，承辦人員仍須確認申請人身分，並確保相關紀錄正確保存，以降低爭議與詐騙風險。", "In recent years, more and more people have used online services to check the status of mail or submit applications. However, for services involving personal information or financial transactions, staff members must still verify the applicant's identity and ensure that relevant records are accurately kept in order to reduce disputes and the risk of fraud.", "重點：in recent years、online services、mail status、personal information、financial transactions、verify identity、reduce disputes and fraud risks。", 5),
  text("Translation", "translation_zh_en", "Translate into English:\n如果顧客申訴郵件延誤或遺失，郵局應先確認郵件種類、交寄方式及相關處理紀錄，再依規定說明可否查詢或請求補償。清楚的程序不但能保障民眾權益，也能避免第一線人員作出不一致的判斷。", "If a customer complains that a piece of mail has been delayed or lost, the post office should first confirm the type of mail, the method of mailing, and the relevant handling records before explaining whether an inquiry or a claim for compensation may be made under the regulations. A clear procedure can protect the rights of the public and prevent front-line employees from making inconsistent decisions.", "重點：complains、delayed or lost、type of mail、method of mailing、handling records、claim for compensation、front-line employees、inconsistent decisions。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nPhilippine nationals could become eligible for visa-free entry for stays in Taiwan of up to 14 days as early as next month, the Ministry of Foreign Affairs said yesterday. The government plans to introduce the measure on a trial basis to promote people-to-people, tourism and commercial exchanges between Taiwan and the Philippines, while encouraging Manila to grant Taiwanese nationals similar treatment under the principle of reciprocity.", "外交部昨日表示，菲律賓籍人士最快自下個月起可能符合免簽證入境臺灣、停留最多十四天的資格。政府計畫以試辦方式推動這項措施，以促進臺灣與菲律賓之間的人員往來、觀光及商業交流，同時鼓勵馬尼拉依互惠原則給予臺灣民眾類似待遇。", "重點：Philippine nationals、visa-free entry、up to 14 days、trial basis、people-to-people exchanges、principle of reciprocity。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nBefore the revised regulations take effect, all branch offices must review their existing forms and service notices. If outdated information remains available to the public, customers may misunderstand their rights or miss important deadlines, which could lead to complaints and unnecessary administrative burdens.", "修正後的規定生效前，各分局必須檢視現行表單與服務公告。如果過時資訊仍提供給民眾，顧客可能誤解自身權利或錯過重要期限，進而造成申訴及不必要的行政負擔。", "重點：revised regulations、take effect、existing forms、outdated information、misunderstand rights、miss deadlines、administrative burdens。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nAlthough digital services have made many postal and financial transactions more convenient, they have also increased the importance of information security. Employees who are authorized to access customer records must use the system only for official purposes and must not disclose personal data to anyone who has no legal basis to receive it.", "雖然數位服務使許多郵政與金融交易更加便利，但也提高了資訊安全的重要性。經授權得查閱顧客紀錄的員工，只能基於公務目的使用系統，且不得向沒有法律依據可取得資料的人揭露個人資料。", "重點：digital services、postal and financial transactions、information security、authorized、official purposes、legal basis、personal data。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nThe new complaint-handling system requires staff members to classify each case according to its cause, such as delayed delivery, incorrect information, or disputes over fees. Managers believe that analyzing these categories will help identify repeated problems and improve training for front-line employees.", "新的申訴處理系統要求員工依原因將每一案件分類，例如投遞延誤、資訊錯誤或費用爭議。管理人員認為，分析這些類別將有助於找出重複發生的問題，並改善第一線員工的訓練。", "重點：complaint-handling system、classify each case、delayed delivery、incorrect information、disputes over fees、identify repeated problems、front-line employees。", 5),
];
