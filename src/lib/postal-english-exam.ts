...
const operationTranslation = [
  text("Translation", "translation_zh_en", "Translate into English:\n一名臺灣羽球選手在國際公開賽決賽中擊敗世界排名較高的對手，替代表隊拿下本季第一面金牌。賽後她表示，前一晚因為肩膀不適幾乎無法入睡，但教練與隊友不斷鼓勵她專注在每一分，讓她能在落後時穩住情緒並完成逆轉。", "A Taiwanese badminton player defeated a higher-ranked opponent in the final of an international open tournament and won the national team's first gold medal of the season. After the match, she said that she could hardly sleep the night before because of shoulder discomfort, but her coach and teammates kept encouraging her to focus on one point at a time, which helped her remain calm when she was behind and complete the comeback.", "重點：badminton player、higher-ranked opponent、international tournament、could hardly sleep、shoulder discomfort、focus on one point at a time、complete the comeback。", 5),
  text("Translation", "translation_zh_en", "Translate into English:\n市政府宣布，明年起將擴大公共自行車站點，並優先設置於捷運站、學校與醫院附近。官員指出，這項政策不只是為了減少交通壅塞，也希望鼓勵民眾以較低碳的方式完成短程移動，進一步改善城市空氣品質。", "The city government announced that it would expand the number of public bicycle stations starting next year, giving priority to locations near metro stations, schools and hospitals. Officials pointed out that the policy is intended not only to reduce traffic congestion but also to encourage residents to make short trips in a lower-carbon way, thereby further improving urban air quality.", "重點：expand public bicycle stations、give priority to、traffic congestion、lower-carbon、short trips、urban air quality。", 5),
  text("Translation", "translation_zh_en", "Translate into English:\n近年來，越來越多民眾使用線上服務查詢申請進度或繳納費用。然而，對於涉及個人資料或金融交易的業務，承辦人員仍須確認申請人身分，並確保相關紀錄正確保存，以降低爭議與詐騙風險。", "In recent years, more and more people have used online services to check the progress of applications or pay fees. However, for services involving personal information or financial transactions, staff members must still verify the applicant's identity and ensure that relevant records are accurately kept in order to reduce disputes and the risk of fraud.", "重點：in recent years、online services、application progress、pay fees、personal information、financial transactions、verify identity、reduce disputes and fraud risks。", 5),
  text("Translation", "translation_zh_en", "Translate into English:\n如果民眾申訴公共服務延誤或資料登錄錯誤，承辦單位應先確認案件類型、申請時間及相關處理紀錄，再依規定說明可否更正或請求補救。清楚的程序不但能保障民眾權益，也能避免第一線人員作出不一致的判斷。", "If members of the public complain about a delay in public services or an error in data entry, the responsible agency should first confirm the type of case, the time of application and the relevant handling records before explaining whether a correction or remedy may be requested under the regulations. A clear procedure can protect the rights of the public and prevent front-line employees from making inconsistent decisions.", "重點：complain about a delay、data entry error、responsible agency、handling records、correction or remedy、front-line employees、inconsistent decisions。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nSeveral cities are considering a pilot program that would allow senior citizens to use certain public sports facilities free of charge during off-peak hours. The proposal is intended to encourage regular exercise, reduce medical costs in the long run, and make better use of facilities that are often underused on weekday mornings.", "數個城市正考慮推動一項試辦計畫，允許高齡者在離峰時段免費使用特定公共運動設施。該提案旨在鼓勵規律運動、長期降低醫療成本，並更有效利用平日上午經常使用率偏低的設施。", "重點：pilot program、senior citizens、free of charge、off-peak hours、regular exercise、medical costs、underused facilities。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nBefore the revised safety guidelines take effect, all schools must review their existing emergency plans and inform parents of the new procedures. If outdated information remains available to the public, students and parents may misunderstand their responsibilities or miss important deadlines, which could lead to confusion during an actual emergency.", "修正後的安全指引生效前，各校必須檢視現行緊急應變計畫，並通知家長新的程序。如果過時資訊仍提供給民眾，學生與家長可能誤解自身責任或錯過重要期限，進而在真正發生緊急狀況時造成混亂。", "重點：revised safety guidelines、take effect、emergency plans、inform parents、outdated information、responsibilities、actual emergency。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nAlthough digital services have made many public applications more convenient, they have also increased the importance of information security. Employees who are authorized to access personal records must use the system only for official purposes and must not disclose private information to anyone who has no legal basis to receive it.", "雖然數位服務使許多公共申請程序更加便利，但也提高了資訊安全的重要性。經授權得查閱個人紀錄的員工，只能基於公務目的使用系統，且不得向沒有法律依據可取得資料的人揭露私人資訊。", "重點：digital services、public applications、information security、authorized、personal records、official purposes、legal basis。", 5),
  text("Translation", "translation_en_zh", "Translate into Chinese:\nThe new complaint-handling system requires staff members to classify each case according to its cause, such as delayed processing, incorrect information, or disputes over fees. Managers believe that analyzing these categories will help identify repeated problems and improve training for front-line employees.", "新的申訴處理系統要求員工依原因將每一案件分類，例如處理延誤、資訊錯誤或費用爭議。管理人員認為，分析這些類別將有助於找出重複發生的問題，並改善第一線員工的訓練。", "重點：complaint-handling system、classify each case、delayed processing、incorrect information、disputes over fees、identify repeated problems、front-line employees。", 5),
];
