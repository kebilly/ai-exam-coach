...
const longCivilLawSeeds: LawSeed[] = [
  {
    rubric_id: "civil_law_article_88_error_revocation",
    topic: "意思表示",
    difficulty: "考古題情境式",
    scenarios: [
      lawScenario("甲到二手精品店向乙購買一只標示為限量聯名款之手錶。乙表示該錶保存良好，並稱其市場價格近來上漲，甲遂以高於一般二手錶之價格購買。交付後，甲送請專業店家鑑定，發現該錶並非限量聯名款，而是外觀相似之一般款式；若甲事前知道此事，即不會以該價格購買。乙則主張甲只是買貴，價格判斷錯誤不能撤銷。甲得否依民法第88條撤銷其買受意思表示？請說明理由。", "區分內容錯誤、動機錯誤、物之性質在交易上是否重要，以及表意人是否有過失。"),
      lawScenario("甲欲承租乙所有之店面經營餐飲業。簽約前，甲曾向乙表示承租目的係開設小吃店，乙亦出示附近商圈資料，使甲誤信該地可供餐飲營業。契約成立後，甲申請相關許可時始知該建物因使用分區限制不得作為餐飲營業場所。乙表示租賃契約已成立，甲應自行承擔營業許可風險。甲得否主張其意思表示有錯誤而撤銷？", "注意交易目的是否進入契約基礎，以及該錯誤是否屬交易上重要之性質錯誤。"),
      lawScenario("甲公司向乙公司採購一批零件，採購人員在報價確認書上誤將單價新臺幣一百元打成十元，並以電子郵件寄給乙。乙收到後立即回覆同意，且要求甲依報價供貨。甲公司於隔日發現錯誤，立即通知乙該報價係輸入錯誤並表示撤銷。乙則主張甲公司內部疏失不應影響交易安全。甲公司是否得撤銷意思表示？", "應處理表示內容錯誤、表意人過失，以及撤銷後可能的信賴利益問題。"),
      lawScenario("甲在網路平台向乙購買一幅畫作。商品頁面以醒目文字標示為某知名畫家早期作品，並附有乙自行製作之收藏說明。甲因相信該畫為真跡而高價購買，收受後經鑑定發現僅為仿作。乙抗辯其並未保證真偽，且甲購買藝術品本應自行鑑定。甲得否依錯誤撤銷其意思表示？", "重點在真偽是否屬物之性質、交易上重要性，以及甲是否可歸責。"),
    ],
  },
  {
    rubric_id: "civil_law_unjust_enrichment_179",
    ...
    difficulty: "考古題情境式",
    scenarios: [
      lawScenario("甲原欲以網路銀行匯款新臺幣三萬元給房東丙作為租金，卻因複製帳號時誤貼成乙之帳戶。乙收到款項後，銀行通知其有不明款項入帳；甲亦於隔日聯繫乙說明匯款錯誤並請求返還。乙表示自己與甲沒有契約關係，且款項已進入其帳戶，拒絕返還。甲得否依民法向乙請求返還？乙若已知情仍花用該款，法律效果有何不同？", "分析受利益、他人受損害、無法律上原因與惡意受領返還範圍。"),
      lawScenario("甲公司委託銀行發放員工獎金，因名冊匯入錯誤，將應發給員工丙之獎金新臺幣五萬元匯入離職員工乙之帳戶。乙收到款項後，明知自己早已離職且無領取獎金資格，仍將款項用於清償私人債務。甲公司發現後向乙請求返還，乙抗辯其已無現存利益。甲公司之請求是否有理由？", "注意乙受有利益、甲受損害、無法律上原因，以及惡意受領不得主張利益不存在。"),
      lawScenario("甲購買家電時，已於門市刷卡支付價金。數日後，甲誤以為該筆交易尚未付款，又透過行動支付轉帳新臺幣一萬二千元給乙電器行。乙會計查帳後發現甲已重複付款，卻以公司資金周轉困難為由暫不退款。甲得否請求返還？其請求權基礎為何？", "避免只寫公平，應具體說明無法律上原因與返還利益。"),
      lawScenario("甲向乙訂購商品，雙方約定貨到付款。因物流系統設定錯誤，乙收到商品時未支付價金即完成取貨。甲發現後通知乙補付價金，乙則表示系統顯示免付款，自己並無故意或過失，因此不須負責。甲得否向乙主張返還利益或支付相當價額？", "不當得利不以故意過失為成立要件，重點在利益與法律上原因。"),
    ],
  },
  {
    rubric_id: "civil_law_tort_184",
    ...
    difficulty: "考古題情境式",
    scenarios: [
      lawScenario("甲騎乘機車行經商店街時，因低頭查看手機訊息，未注意前方乙正停等紅燈，遂從後方撞上乙之機車。乙機車倒地後車殼破裂，安全帽亦摔壞，乙支出修理費並主張車輛價值減損。甲表示自己並非故意，且乙仍可騎車離開，拒絕賠償。乙得否依民法第184條第1項前段向甲請求損害賠償？賠償範圍如何判斷？", "具體涵攝過失、所有權侵害、損害、因果關係與損害賠償方法。"),
      lawScenario("甲在辦公室搬運大型包裹時，為求方便未使用推車，也未確認包裹是否固定，即逕自將包裹堆放在乙辦公桌旁。稍後包裹滑落，砸壞乙放在桌上的筆記型電腦，導致乙需支付維修費並暫時無法使用。甲抗辯包裹滑落是意外，自己沒有賠償義務。乙得如何主張？", "不要只寫有損害，要說明注意義務違反如何構成過失。"),
      lawScenario("甲在社群平台上未查證即公開指稱乙販售假貨，並附上片段對話截圖。事後證明乙販售之商品均為真品，乙因此遭取消合作邀約，且多名客戶要求退款。乙主張其名譽、信用及營業利益受損，請求甲負侵權行為責任。乙之主張是否有理由？", "處理人格法益、信用或名譽侵害、過失、因果關係與財產/非財產損害。"),
      lawScenario("甲未經確認即向多家金融機構通報乙偽造申請文件，事後證明該文件並非偽造。乙因此申辦信用卡與貸款均遭拒絕，並支出額外費用尋求其他融資管道。甲主張其只是基於防止詐欺之善意提醒，不應負損害賠償責任。乙得否向甲主張侵權行為損害賠償？", "注意信用權、名譽權、第184條與第195條的可能連結。"),
    ],
  },
  {
    rubric_id: "civil_law_sale_defect",
    ...
    difficulty: "考古題情境式",
    scenarios: [
      lawScenario("甲向乙購買中古筆電一台，乙於交易前明確表示該筆電可正常開機、充電並執行文書軟體，甲因準備工作需要而購買。交付後，甲第一次使用即發現筆電無法開機，送修後店家表示主機板早已有故障跡象。甲於收受當日通知乙，乙則表示中古商品本來就有風險，拒絕退貨或減價。甲得向乙主張何種權利？", "分析第354條瑕疵、保證品質、第359、360條與第227條不完全給付。"),
      lawScenario("甲向乙購買二手投影機供公司簡報使用，乙稱亮度正常且可連接筆電。甲交付價金並收受後，於第一次會議使用時發現投影畫面嚴重閃爍，且連線經常中斷，導致簡報無法完成。甲通知乙後，乙表示設備仍能勉強投影，不構成瑕疵。甲得否解除契約、請求減少價金或損害賠償？", "法律效果要分別處理，不要只寫可請求賠償。"),
      lawScenario("甲向乙購買一批辦公椅，乙保證椅腳穩固且適合一般辦公使用。交付後一週內，多張椅子陸續出現椅腳鬆脫，甚至有員工坐下時險些跌倒。甲立即通知乙並要求處理，乙主張甲已收受並使用，且辦公椅屬消耗性物品，不得再主張瑕疵。甲得如何依民法主張權利？", "留意通常效用、保證品質、檢查通知義務與損害賠償。"),
      lawScenario("甲向乙購買中古手機，乙保證電池健康度良好且可正常充電。甲收受後三日內發現手機充電孔故障，必須更換零件始能正常使用，且因無法使用手機而錯過重要工作聯繫。乙表示甲購買前已看過外觀，故不得再請求任何責任。甲得否主張瑕疵擔保或不完全給付？", "可同時討論瑕疵擔保、不完全給付、可歸責性與損害範圍。"),
    ],
  },
  {
    rubric_id: "civil_law_transfer_good_faith",
    ...
    difficulty: "考古題情境式",
    scenarios: [
      lawScenario("甲將名家茶具一組借給乙於展覽會陳列，約定展覽結束後即返還。乙因急需用錢，向丙謊稱茶具為自己所有，並以市價出售給不知情之丙，雙方當場完成付款及交付。甲發現後主張茶具係其所有，乙無權出售，欲向丙請求返還。請分別說明乙、丙間買賣契約與所有權移轉行為之效力，並判斷甲得否向丙請求返還。", "區分負擔行為、處分行為、無權處分與善意取得。"),
      lawScenario("甲將畫作交由乙保管，並明確告知乙不得出售。乙未經甲同意，以自己名義將畫作出售給善意且無重大過失之丙，並完成交付。甲事後向丙表示乙無處分權，要求丙返還畫作；丙則主張自己信賴乙占有該畫作而買受。甲之請求是否成立？", "注意動產占有公信力、善意取得與第767條返還請求。"),
      lawScenario("甲將古董相機借給乙使用一週。乙於借用期間將相機帶至二手店出售給丙，丙查驗外觀與功能後即付款受領，並不知道相機並非乙所有。甲發現後主張自己從未同意出售，欲依所有物返還請求權向丙取回相機。請分析甲、乙、丙間法律關係。", "不要把買賣契約效力與所有權移轉效力混為一談。"),
      lawScenario("甲委託乙展售雕像，但明確表示須經甲最後同意始得出售。乙為取得佣金，未經甲同意即將雕像出售並交付給不知情之丙。甲認為乙違反委託約定，丙不得取得所有權；丙則主張其善意受讓。甲得否向丙請求返還雕像？乙、丙間法律行為效力如何？", "處理授權範圍、無權處分、善意受讓與所有物返還。"),
    ],
  },
  {
    rubric_id: "civil_law_inheritance_basic",
    ...
    difficulty: "考古題情境式",
    scenarios: [
      lawScenario("甲死亡，遺有配偶乙及子女丙、丁，遺產總額為新臺幣一百二十萬元。甲生前未留下遺囑，也沒有其他繼承人。乙主張自己長期照顧甲，應取得較多遺產；丙、丁則主張應依法平均分配。請說明乙、丙、丁是否均為繼承人，其應繼分比例與可分得金額各為多少。", "先確認配偶與子女同為繼承人，再計算應繼分。"),
      lawScenario("甲死亡，未留子女，遺有配偶乙及父母丙、丁，遺產共新臺幣九十萬元。乙認為配偶應取得全部遺產，丙、丁則主張父母仍有繼承權。請依民法規定說明乙、丙、丁是否得繼承，以及其應繼分如何計算。", "注意配偶與父母共同繼承時的比例。"),
      lawScenario("甲死亡，遺有配偶乙及子女丙、丁。甲生前立遺囑表示全部遺產均由乙取得，未分配任何財產給丙、丁。丙、丁認為自己身為子女仍應受到最低保障，向乙主張特留分。丙、丁之主張是否有理由？其計算基礎為何？", "先算應繼分，再以應繼分為基礎計算特留分。"),
      lawScenario("甲死亡，遺有配偶乙、子女丙，以及已先於甲死亡之子女丁的子女戊。甲未留下遺囑，遺產共新臺幣一百八十萬元。乙主張戊只是孫子女，不能與配偶及子女共同分配；戊則主張其可代位繼承丁之應繼分。請說明戊是否得代位繼承，以及乙、丙、戊之應繼分如何計算。", "注意代位繼承與配偶共同繼承的計算。"),
    ],
  },
];

function getLawSeedPool() {
  return longCivilLawSeeds;
}
